    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (editingSpecialty) {
                ...
                const res = await api.put(`/admin/specialties/${editingSpecialty._id}`, payload);
...
const s = {
    // Layout specifics
    layout: { display: 'flex', flexDirection: 'column', height: '100vh', width: '100%', backgroundColor: '#f8fafc', overflow: 'hidden', position: 'relative' },
