...
import { Search, HeartHandshake, CheckCircle, ArrowRight, MessageSquare, ShieldCheck, Heart, User, ChevronDown, Facebook, Twitter, Instagram, Calendar } from 'lucide-react';
import './Home.css';
import gradHero from '../assets/GRAD.jpg';
...
const Home = () => {
    ...
    const counselors = [
        { name: 'Dr. Sarah Chen', specialty: 'Ph.D, Counseling Psychology', rating: 4.9, reviews: 235, bio: 'Specializes in anxiety, stress management and workplace burnout using cognitive...', image: 'https://images.unsplash.com/photo-1551836022-d5d88e9218df?q=80&w=600&h=600&auto=format&fit=crop&crop=faces' },
        { name: 'Mark Thompson', specialty: 'LMFT, Couples Therapy', rating: 4.8, reviews: 184, bio: 'Expert in rebuilding communication and trust for couples at all stages of their relationship...', image: 'https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?q=80&w=600&h=600&auto=format&fit=crop&crop=faces' },
        { name: 'Dr. Elena Rodriguez', specialty: 'Psy.D, Trauma Specialist', rating: 5.0, reviews: 212, bio: 'Helping individuals overcome past trauma and build resilience through evidence-based...', image: 'https://images.unsplash.com/photo-1594824476967-48c8b964273f?q=80&w=600&h=600&auto=format&fit=crop&crop=faces' }
    ];
        ...
        <div className="home-container">
            ...
            <nav className="home-nav">
                <div className="nav-content">
                    <div className="nav-brand">
                        <HeartHandshake className="brand-logo" strokeWidth={2.5} />
            ...
            <section className="hero-section">
                <div className="hero-content">
                    <span className="hero-tag">Official SLIIT Counseling Portal</span>
                    <h1>Empowering Minds <span className="text-gradient">Shaping Futures</span></h1>
                    <p>Access professional, confidential counseling services tailored for the SLIIT community. Your mental well-being is the foundation of your academic and personal success.</p>
                    ...
                    <div className="hero-social">
                        <div className="avatars">
                            <img src="https://images.unsplash.com/photo-1438761681033-6461ffad8d80?q=80&w=100&h=100&auto=format&fit=crop&crop=faces" alt="user" />
                            <img src="https://images.unsplash.com/photo-1500648767791-00dcc994a43e?q=80&w=100&h=100&auto=format&fit=crop&crop=faces" alt="user" />
                            <img src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?q=80&w=100&h=100&auto=format&fit=crop&crop=faces" alt="user" />
                        </div>
                ...
                <div className="hero-image-container">
                    <div className="image-blob">
                        <img src={gradHero} alt="SLIIT Graduation" />
                    </div>
                    <div className="live-badge">
                        <div className="pulse" />
                        <span>Available Now: <strong>Professional Counselors</strong></span>
                    </div>
                </div>
            </section>
            ...
            <footer className="home-footer">
                <div className="footer-content">
                    <div className="footer-brand">
                        <div className="nav-brand">
                            <HeartHandshake style={{ color: 'var(--h-secondary)' }} strokeWidth={2.5} />
                            <span>MindBridge</span>
                        </div>
                        <p>Providing high-quality, accessible, and confidential mental health support to SLIIT students and staff.</p>
